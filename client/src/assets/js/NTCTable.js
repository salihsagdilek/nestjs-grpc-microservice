...
export function size(associativeArray) {
    var size = 0,
        key;
...
export function selector(string, type) {
    var prefix;
    if (type) {
        switch (type) {
            case 'id':
...
export function actualOrPlaceholder(object, key, placeholder) {
    var outputValue;
 ...
 */
export function NTCTable(dataSourceArray, tableHeadersArray) {
    this.openTag;
    this.closeTag;
    this.dataSource;
    this.tableHeaders;
 ...
 */
export function NTCRow(NTCCellObjectArray, rowKey) {
    this.openTag;
    this.closeTag;
    this.cellsArray;
    this.rowKey;
 ...
 */
export function NTCCell(cellData) {
    var openTag;
    var closeTag;
    var cellData;
